...
class Slic {
        private:
                ...
                //vec2di clusters; //* MOVED TO PUBLIC *//
                //vec2dd distances; //* MOVED TO PUBLIC *//
                //
                ///* The LAB and xy values of the centers. */
                //vec2dd centers; //* MOVED TO PUBLIC *//
        ...
        public:
                ...
                vector<CvPoint> find_neighbors(IplImage *image, int x, int y); /* ADDED ! */
				...
				/* clusters with enforced connectivity*/
				vec2di new_clusters;

				/* getting coordinates of center of sup.pix. by label*/
				vector<CvPoint> label_map;


                vector<CvScalar> mean_colours;
};
